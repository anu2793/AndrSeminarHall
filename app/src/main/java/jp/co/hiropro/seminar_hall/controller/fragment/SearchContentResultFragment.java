...
public class SearchContentResultFragment extends FragmentBase implements TopContentFragment.OnSearchListener,
    ...
    public static SearchContentResultFragment newInstance(String keySearch) {
        SearchContentResultFragment fragment = new SearchContentResultFragment();
    ...
    private void setupTabLayout() {
        ...
        tvTabs.setText("無料人気");
        tabLayout.getTabAt(2).setCustomView(viewFreeVideo);
        ...
        tvTabs.setText("有料人気");
        tabLayout.getTabAt(3).setCustomView(viewPaidVideo);
    }
