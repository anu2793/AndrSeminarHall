...
public class SearchResultDefaultFragment extends FragmentBase implements Paginate.Callbacks {
    ...
    private int page = 1;
    private int mType = AppConstants.TYPE_SEARCH.ALL;
    ...
    public static SearchResultDefaultFragment newInstance(String keySearch) {
        SearchResultDefaultFragment fragment = new SearchResultDefaultFragment();
    ...
    public void initSearchResult() {
        adapter = new SearchResultAdapter(activity, searchResultList);
