...
public class TagFragment extends FragmentBase implements Paginate.Callbacks {
    ...
    public static TagFragment newInstance(String tag, int type, SubCategory cate) {
...
//
//                            } else {
//                                HSSDialog.show(activity, getString(R.string.msg_session_expire), getString(R.string.txt_ok), new View.OnClickListener() {
//                                    @Override
