...
public class RecyclerSubCategoryNoDescriptionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerSubCategoryNoDescriptionAdapter(Context context, ArrayList<SubCategory> list) {
        this.mContext = context;
        this.mListSub = list;
    }

    public RecyclerSubCategoryNoDescriptionAdapter(Context context, ArrayList<SubCategory> list, User user) {
        this.mContext = context;
        this.mListSub = list;
        this.mUser = user;
    }
...
//        } else {
//            View view = LayoutInflater.from(mContext).inflate(R.layout.item_subcategory_no_description, parent, false);
