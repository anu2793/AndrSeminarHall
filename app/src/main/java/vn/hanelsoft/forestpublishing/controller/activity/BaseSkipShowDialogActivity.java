...
import vn.hanelsoft.forestpublishing.controller.fragment.TopSeminarFragment;
...
public abstract class BaseSkipShowDialogActivity extends AppCompatActivity implements View.OnClickListener {
...
//        }
    ...
    private void goEditCreateProfile() {
        Intent intent = new Intent(BaseSkipShowDialogActivity.this, EditProfileActivity.class);
...
//                    startActivity(new Intent(activity, ProfileActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                ...
                case R.id.tv_logout_social:
                    HSSDialog.show(BaseSkipShowDialogActivity.this, getString(R.string.msg_confirm_logout), getString(R.string.txt_ok), new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
    ...
    public void sendRequestLogOut() {
        showLoading();
        RequestDataUtils.requestData(Request.Method.GET, BaseSkipShowDialogActivity.this, AppConstants.SERVER_PATH.LOGOUT.toString(), null, new RequestDataUtils.onResult() {
            @Override
    ...
    private void logout() {
        AccountUtils.clearAllAccountOfThisApplication(BaseSkipShowDialogActivity.this, mManagerAccount);
        HSSPreference.getInstance(BaseSkipShowDialogActivity.this).putInt(AppConstants.KEY_PREFERENCE.IS_SOCIAL.toString(), 0);
        HSSPreference.getInstance(BaseSkipShowDialogActivity.this).putString(AppConstants.KEY_PREFERENCE.ACCESS_TOKEN.toString(), AppConstants.StaticParam.EMPTY_VALUE_STRING);
        dismissLoading();
        //Clear shortcut badger.
        ShortcutBadger.applyCount(getApplicationContext(), 0);
        startActivity(new Intent(BaseSkipShowDialogActivity.this, LoginActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
        finish();
    }
    ...
    private void logoutAgain() {
        HSSDialog.show(BaseSkipShowDialogActivity.this, getString(R.string.msg_login_error_try_again), getString(R.string.txt_ok), new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                HSSDialog.dismissDialog();
                sendRequestLogOut();
