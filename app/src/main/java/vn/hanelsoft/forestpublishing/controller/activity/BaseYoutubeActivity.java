...
import vn.hanelsoft.forestpublishing.view.dialog.AdviseDialog;
...
//        }
        ...
        if (user == null)
            user = User.getInstance().getCurrentUser();
        mIsShow = HSSPreference.getInstance().getBoolean(AppConstants.KEY_PREFERENCE.IS_REGISTER_SUCCESS.toString(), false);
        if (mIsShow)
            showAdviseDialog();
    }
    ...
    private void showAdviseDialog() {
        ...
        AdviseDialog dialog = new AdviseDialog(BaseYoutubeActivity.this);
    ...
    private void goEditCreateProfile() {
        Intent intent = new Intent(BaseYoutubeActivity.this, EditProfileActivity.class);
...
//                    startActivity(new Intent(activity, ProfileActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
                ...
                case R.id.tv_logout_social:
                    HSSDialog.show(BaseYoutubeActivity.this, getString(R.string.msg_confirm_logout), getString(R.string.txt_ok), new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
    ...
    public void sendRequestLogOut() {
        showLoading();
        RequestDataUtils.requestData(Request.Method.GET, BaseYoutubeActivity.this, AppConstants.SERVER_PATH.LOGOUT.toString(), null, new RequestDataUtils.onResult() {
            @Override
    ...
    private void logout() {
        AccountUtils.clearAllAccountOfThisApplication(BaseYoutubeActivity.this, mManagerAccount);
        HSSPreference.getInstance(BaseYoutubeActivity.this).putInt(AppConstants.KEY_PREFERENCE.IS_SOCIAL.toString(), 0);
        HSSPreference.getInstance(BaseYoutubeActivity.this).putString(AppConstants.KEY_PREFERENCE.ACCESS_TOKEN.toString(), AppConstants.StaticParam.EMPTY_VALUE_STRING);
        dismissLoading();
        //Clear shortcut badger.
        ShortcutBadger.applyCount(getApplicationContext(), 0);
        startActivity(new Intent(BaseYoutubeActivity.this, LoginActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
        finish();
    }
    ...
    private void logoutAgain() {
        HSSDialog.show(BaseYoutubeActivity.this, getString(R.string.msg_login_error_try_again), getString(R.string.txt_ok), new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                HSSDialog.dismissDialog();
                sendRequestLogOut();
