package vn.hanelsoft.forestpublishing.view.tagsview;
...
public class TagView extends RelativeLayout {
    ...
    private void drawTags() {
        ...
        for (Tag item : mTags) {
            ...
            LinearLayout mLLContaienr = (LinearLayout) tagLayout.findViewById(R.id.ll_layout);
            ...
            float tagWidth = tagView.getPaint().measureText(tag.text) + 2 * (textPaddingLeft + textPaddingRight);
    ...
    private Drawable getSelector(Tag tag) {
        ...
        Drawable myIcon = getResources().getDrawable(R.drawable.ic_bg_tag_new);
        return myIcon;
    }
